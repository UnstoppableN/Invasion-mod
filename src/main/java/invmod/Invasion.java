...
import invmod.common.util.*;
import invmod.common.util.spawneggs.*;
...
//@Mod(modid = Reference.MODID + "_OLD", name = Reference.NAME + "_OLD", version = Reference.VERSION + "_OLD")
...
//	}
    ...
    public static Invasion getLoadedInstance() {
        return instance;
    }
    ...
    private void loadHealthConfig() {
        //Invasion spawns
        mobHealthInvasion.put("IMCreeper-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMCreeper-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMVulture-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMVulture-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMImp-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMImp-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMPigManEngineer-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMPigManEngineer-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMSkeleton-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSkeleton-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMSpider-T1-Spider-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T1-Spider-invasionSpawn-health", 18));
        mobHealthInvasion.put("IMSpider-T1-Baby-Spider-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T1-Baby-Spider-invasionSpawn-health", 3));
        mobHealthInvasion.put("IMSpider-T2-Jumping-Spider-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T2-Jumping-Spider-invasionSpawn-health", 18));
        mobHealthInvasion.put("IMSpider-T2-Mother-Spider-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T2-Mother-Spider-invasionSpawn-health", 23));
        mobHealthInvasion.put("IMThrower-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMThrower-T1-invasionSpawn-health", 50));
        mobHealthInvasion.put("IMThrower-T2-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMThrower-T2-invasionSpawn-health", 70));
        mobHealthInvasion.put("IMZombie-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMZombie-T2-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T2-invasionSpawn-health", 30));
        mobHealthInvasion.put("IMZombie-T3-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T3-invasionSpawn-health", 65));
        mobHealthInvasion.put("IMZombiePigman-T1-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T1-invasionSpawn-health", 20));
        mobHealthInvasion.put("IMZombiePigman-T2-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T2-invasionSpawn-health", 30));
        mobHealthInvasion.put("IMZombiePigman-T3-invasionSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T3-invasionSpawn-health", 65));

        //Nightspawns
        mobHealthNightspawn.put("IMCreeper-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMCreeper-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMVulture-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMVulture-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMImp-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMImp-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMPigManEngineer-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMPigManEngineer-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMSkeleton-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSkeleton-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMSpider-T1-Spider-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T1-Spider-nightSpawn-health", 18));
        mobHealthNightspawn.put("IMSpider-T1-Baby-Spider-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T1-Baby-Spider-nightSpawn-health", 3));
        mobHealthNightspawn.put("IMSpider-T2-Jumping-Spider-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T2-Jumping-Spider-nightSpawn-health", 18));
        mobHealthNightspawn.put("IMSpider-T2-Mother-Spider-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMSpider-T2-Mother-Spider-nightSpawn-health", 23));
        mobHealthNightspawn.put("IMThrower-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMThrower-T1-nightSpawn-health", 50));
        mobHealthNightspawn.put("IMThrower-T2-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMThrower-T2-nightSpawn-health", 70));
        mobHealthNightspawn.put("IMZombie-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMZombie-T2-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T2-nightSpawn-health", 30));
        mobHealthNightspawn.put("IMZombie-T3-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombie-T3-nightSpawn-health", 65));
        mobHealthNightspawn.put("IMZombiePigman-T1-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T1-nightSpawn-health", 20));
        mobHealthNightspawn.put("IMZombiePigman-T2-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T2-nightSpawn-health", 30));
        mobHealthNightspawn.put("IMZombiePigman-T3-nightSpawn-health", Invasion.configInvasion.getPropertyValueInt("IMZombiePigman-T3-nightSpawn-health", 65));
...
//        itemSpawnEgg = new ItemSpawnEgg();
        ...
        if (debugMode) {
            itemDebugWand = new ItemWandDebug();
